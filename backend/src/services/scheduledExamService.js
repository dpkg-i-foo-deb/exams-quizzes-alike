...
const getAvailableExams = async (req,res) =>
{
    ...
    const response = await connectionPool.query(`	SELECT  e.codigo_examen, ce.codigo_curso, to_char((ce.fecha_presentacion + e.tiempo_limite),'YYYY-MM-DD HH:MM:SS') fecha_maxima FROM curso_examen ce 
